...
export function AdvancedFilters({ bookmarks }: AdvancedFiltersProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      {/* Status Filter */}
      <div className="flex items-center rounded-xl border border-border bg-muted p-1 text-xs">
        <button
      ...
      <div className="flex items-center relative">
        <select
          ...
          className="appearance-none rounded-xl border border-border bg-muted pl-8 pr-8 py-2 text-xs text-foreground focus:outline-none focus:border-foreground transition cursor-pointer"
        >
