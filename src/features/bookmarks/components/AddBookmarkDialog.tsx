            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              ...
              <div className="group relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-2xl border border-white/10 bg-[#121215] pr-4 pl-11 text-sm text-zinc-200 shadow-inner transition-all outline-none placeholder:text-zinc-600 focus:border-indigo-500/40 focus:bg-[#15151a] focus:ring-4 focus:ring-indigo-500/10 disabled:cursor-not-allowed disabled:opacity-50"
                />
              </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="space-y-1.5">
                        <label
                          ...
                          className="block pl-1 font-mono text-[9px] font-bold tracking-widest text-zinc-500 uppercase"
                        >
                          Title Override
                        </label>
                        <input
                          ...
                          className="h-10 w-full rounded-xl border border-white/5 bg-zinc-900/40 px-3 text-xs text-zinc-200 transition-all outline-none placeholder:text-zinc-700 focus:border-indigo-400/30 focus:bg-zinc-900/60 disabled:cursor-not-allowed disabled:opacity-50"
                        />
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative" ref={containerRef}>
                          <input
                            ...
                            className="h-10 w-full rounded-xl border border-white/5 bg-zinc-900/40 px-3 pr-8 text-xs text-zinc-200 transition-all outline-none placeholder:text-zinc-700 focus:border-indigo-400/30 focus:bg-zinc-900/60 disabled:cursor-not-allowed disabled:opacity-50"
                            style={{
                          ...
                          <button
                            ...
                            className="absolute top-1/2 right-2 flex -translate-y-1/2 cursor-pointer items-center justify-center disabled:cursor-not-allowed disabled:opacity-50"
                          >
                            <motion.div
                            ...
                            {isDropdownOpen &&
                              totalVisibleDropdownOptions > 0 && (
                                <motion.div
                                  ...
                                  className="absolute top-[calc(100%+6px)] right-0 left-0 z-50 max-h-52 overflow-hidden overflow-y-auto rounded-xl border border-white/10 bg-[#121215] shadow-2xl"
                                    ...
                                    ({ label, icon: Icon }, itemIndex) => {
                                      ...
                                      return (
                                        <div
                                          ...
                                          className="flex w-full cursor-pointer items-center gap-2.5 px-3 py-2 text-xs transition-colors select-none"
                                          style={{
              ...
              <div className="flex items-center justify-end gap-2 border-t border-white/5 pt-5">
                ...
                <motion.button
                  ...
                  disabled={!canSubmit}
                  className={cn(
                    "relative flex min-w-[130px] cursor-pointer items-center justify-center overflow-hidden rounded-xl px-5 py-2.5 text-xs font-bold shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all disabled:cursor-not-allowed disabled:opacity-50",
                    isSuccess
