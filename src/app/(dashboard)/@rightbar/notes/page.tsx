    ...
    <div className="flex flex-col gap-6 p-5 h-full  text-foreground font-sans  text-sm">
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          rows={4}
          className="w-full rounded-xl border border-border bg-muted/40 p-3 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-purple-500/50 transition resize-none"
        />
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="px-2 py-1 rounded-md bg-muted border border-border text-[11px] text-muted-foreground hover:border-purple-400/40 hover:text-purple-300 transition cursor-pointer">
            #ideas (12)
          </span>
          <span className="px-2 py-1 rounded-md bg-muted border border-border text-[11px] text-muted-foreground hover:border-purple-400/40 hover:text-purple-300 transition cursor-pointer">
            #work (9)
