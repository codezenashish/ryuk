  ...
  return (
    <div className="flex flex-col gap-6 p-5 h-full text-ink font-body  text-sm">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 rounded-xl border border-line bg-paper-3/40">
          <div className="text-xs text-ink-3 font-mono">Storage</div>
          <div className="text-lg font-display font-medium text-ink mt-1">4.2 GB</div>
          <div className="w-full bg-line h-1.5 rounded-full mt-2 overflow-hidden">
            <div className="bg-emerald-500 h-full w-[42%]" />
          </div>
        </div>
        <div className="p-3 rounded-xl border border-line bg-paper-3/40">
          <div className="text-xs text-ink-3 font-mono">Tasks</div>
          <div className="text-lg font-display font-medium text-ink mt-1">12 Pending</div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="space-y-2.5">
          <div className="flex items-start gap-2.5 p-2.5 rounded-lg border border-line-2 bg-paper-3/20">
            <span className="p-1 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20">
              <HugeiconsIcon icon={ZapIcon} size={14} />
            </span>
            <div className="min-w-0">
              <p className="text-xs font-medium text-ink">Created &quot;Launch Plan&quot; note</p>
              <span className="text-[10px] text-ink-3 font-mono">10 mins ago</span>
            </div>
          </div>
          <div className="flex items-start gap-2.5 p-2.5 rounded-lg border border-line-2 bg-paper-3/20">
            ...
            <div className="min-w-0">
              <p className="text-xs font-medium text-ink">Saved Next.js documentation</p>
              <span className="text-[10px] text-ink-3 font-mono">1 hour ago</span>
            </div>
          </div>
        </div>
      </div>
