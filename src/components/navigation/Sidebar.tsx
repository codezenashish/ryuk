          ...
          <div className="flex flex-1 scrollbar-none flex-col overflow-y-auto px-4 py-6">
            ...
            <div className="mt-auto pt-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={cn(
                  "group relative mt-6 flex items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-white/5 font-semibold tracking-wide text-zinc-300 transition-all hover:border-white/20 hover:text-white focus-visible:ring-2 focus-visible:ring-indigo-500/50 focus-visible:outline-none",
